...
const GLOBALS = {
  ...
  'process.env.LOGIN_URL': JSON.stringify("https://washing-time.herokuapp.com/login"),
  'process.env.LOGIN_URL_VK': JSON.stringify("https://washing-time.herokuapp.com/login/vk"),
